...
public class ViewCaixa extends javax.swing.JFrame {
    ...
    private FuncionarioDao fun;//recebe o funcionario da tela ViewHome
    private int cont = 0;//Conta quantas vendas foram feitas
    private int contExcluir = 0;//controla as excluções
    private double valor;
    private double ultimoValor;//controla o ultimo valor add para futura exclução
    private int ultimaQte;//controla o ultimo Qte add para futura exclução
    private String ultimacod; //controla o ultimo cod de barras add para futura exclução

    public ViewCaixa(FuncionarioDao fun) {
        initComponents();
        inicializacao();
        this.fun = fun;
    }
    ...
    //sobrecarga da leitura da tabela
    ...
    //metodo responsavel por excluir o ultimo prod add
    ...
    //metodo re´ponsavel por add prod a tabela
    ...
    //logica para add valor no sub total
    ...
    //logica para remolver valor no sub total
    ...
    private String[] Add(String cod) {
        try {
            //metodo q checa a qte de prod no bd e 
            ultimaQte = 0;
            ultimoValor = 0;
            String prod[] = new String[6];
    ...
    private void initComponents() {
        ...
        jPanelFinalcompraLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFinalcompraLayout.createSequentialGroup()
                .addGap(282, 282, 282)
                .addGroup(jPanelFinalcompraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanelFinalcompraLayout.setVerticalGroup(
            ...
            .addGroup(jPanelFinalcompraLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelFinalcompraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jValorclient)
                    .addComponent(jLabel10))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelFinalcompraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jMenuItemSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSairActionPerformed
        try {
            ...
            ViewHome view = new ViewHome(fun);
