...
public class ViewLogin extends javax.swing.JFrame {
    ...
    public ViewLogin() throws Exception {
        initComponents();
        func = new FuncionarioDao();//funcionarioDao iniciado
    ...
    private void jTxtuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTxtuserActionPerformed
        ...
        jButton1ActionPerformed(evt);//chama a action do botao
...
//checa no banco "loginDao" se o usuario e valido 
        try {
            if (login.getLogin(user, pass)) {
                this.dispose();
                view = new ViewHome(Funcionario.getFuncionario(user, pass));//passa o usuario para a tela viewHome
